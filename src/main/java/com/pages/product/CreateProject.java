...
public class CreateProject extends Base_Test {
	...
	public void selectProjectType() {
		try {
			...
			WebElement element = driver
					.findElement(By.xpath("//div[contains(@class,'row p-t-20')]/child::div[1]/div[1]/div/button"));
	...
	public void selectIndustry() {
		try {
			Thread.sleep(1000);
			WebElement element = driver
					.findElement(By.xpath("//div[contains(@class,'row p-t-20')]/child::div[2]/div/div/button[1]"));
			javaScriptClick(element);
	...
	public void selectTargetLanguage() {
		try {
			Thread.sleep(1000);
			WebElement element = driver
					.findElement(By.xpath(".//*[@id='addProjectForm']/div/div[4]/div[2]/div/div/button"));
			javaScriptClick(element);
			btn_english.click();
